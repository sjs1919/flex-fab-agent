...
from flex_fab_agent.config import get_config
from flex_fab_agent.core.utils import fmt_dt, json_list
...
from flex_fab_agent.scheduler.solver import persist, solve
from flex_fab_agent.simulator.states import log_state_change
from flex_fab_agent.tools.data import (format_table, get_connection, load_customers,
...
def _yield_advice(bad_rows: list[dict], total_bad: int, total_done: int,
    ...
    summary = "\n".join(summary_lines)
    try:
        from flex_fab_agent.core.llm_client import call_llm_simple
