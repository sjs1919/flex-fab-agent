...
from flex_fab_agent.eval.judge import judge_semantic_quality, parse_judge_response, _extract_context
from flex_fab_agent.eval.judge_prompt import build_judge_messages, JUDGE_SYSTEM_PROMPT
...
def test_judge_semantic_quality_calls_llm(monkeypatch):
    ...
    from flex_fab_agent.eval import judge as judge_mod
...
def test_judge_no_context_uses_real_judge_for_relevancy(monkeypatch):
    ...
    def fake_call_llm(messages, **kwargs):
        ...
        from flex_fab_agent.eval.judge_prompt import JUDGE_RELEVANCY_SYSTEM_PROMPT
