...
CLI：python -m flex_fab_agent.scheduler.solver --solve [--snapshot snap.json] [--out result.json]
"""
...
from flex_fab_agent.scheduler import assessment, model, verify
from flex_fab_agent.simulator.engine import SHIFT_FACTOR
