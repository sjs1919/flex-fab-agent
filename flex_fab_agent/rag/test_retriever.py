...
from flex_fab_agent.rag import retriever
from flex_fab_agent.rag.knowledge_base import chunk_text, doc_permission, load_documents
from flex_fab_agent.rag.retriever import bm25_search, rerank, rrf_fuse
...
def test_role_from_token_object_and_none():
    ...
    from flex_fab_agent.auth.token_exchange import Token
