...
| 关联 | [重构方案 v1](../04-plans/重构方案-v1-2026-08-21.md) · [需求规格 v1](需求规格-v1-2026-08-21.md) · [模板包 README](https://github.com/sjs1919/agent-training/blob/main/project-standards/README.md) |
